...
This directory contains the Python bindings for the NumPhys src, powered by **pybind11**. It bridges the high-performance C++ numerical core with Python\'s interactive ecosystem (Streamlit, Jupyter, etc.).
...
To build the Python module, navigate to the `bindings/python/` directory and run:
