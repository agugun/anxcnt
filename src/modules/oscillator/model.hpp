 ...
 */
class OscillatorModel : public IModel {
public:
    Mass_kg m;
    Damping_Ns_m c;
    Stiffness_N_m k;
 ...
 */
class OscillatorDiscretizer : public IDiscretizer {
public:
    void build_jacobian(const IGrid& grd, const IModel& base_model, const IState& base_state, SparseMatrix& J) const override {
    ...
    void build_residual(const IGrid& grd, const IModel& base_model, const IState& base_state, Vector& R) const override {
        const auto& mdl = dynamic_cast<const OscillatorModel&>(base_model);
    ...
    void apply_bc(const IGrid& grd, const IModel& base_model, const IState& base_state, SparseMatrix& J, Vector& R) const override {
 ...
 */
class OscillatorGrid : public IGrid {
public:
