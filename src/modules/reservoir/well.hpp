...
public:
    ...
    virtual double get_q_water(const IState& st) const = 0;
};
...
public:
    ...
    double get_q_water(const IState& st) const override { return 0.0; }
};
...
public:
    ...
    using SwFunc = std::function<double(const IState&, int, int)>;
    ...
    double get_q_water(const IState& st) const override {
...
public:
    using IndexFunc = std::function<int(int, int)>;
    using VarFunc = std::function<void(const IState&, int, int, double&, double&, double&)>;
    ...
    double get_q_water(const IState& st) const override { return is_injector ? q_total : 0.0; }
};
...
public:
    using IndexFunc = std::function<int(int, int, int)>;
    using VarFunc = std::function<void(const IState&, int, int, int, double&, double&, double&)>;
    using RelPerm3Func = std::function<void(double, double, double&, double&, double&)>;
